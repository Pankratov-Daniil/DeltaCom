...
public class OptionServiceImpl implements OptionService {
    ...
    public void updateOption(Option option, String[] incompatibleOptionsIds, String[] compatibleOptionsIds) {
        try {
            ...
            if(incompatibleOptionsIds == null) {
                throw new PersistenceException("Incompatible options list cannot be null.");
            }
            if(compatibleOptionsIds == null) {
                throw new PersistenceException("Compatible options list cannot be null.");
            }
